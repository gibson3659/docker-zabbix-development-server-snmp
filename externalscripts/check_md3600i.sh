...
#
#   07.07.2014 - 1.5z * modified for zabbix use by jason.gibson@guavus.com
#########################################################

#SMcli location
COMMAND=/usr/bin/SMcli
...
##execute SMcli
RESULT=$($COMMAND $CTRLA_IP $CTRLB_IP -c "show storageArray healthStatus;")
